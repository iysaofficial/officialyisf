...
export default function Internationalparticipants() {
  ...
  return (
    <>
      <PageTitle motherMenu="INTERNATIONAL PARTICIPANTS" menuback="Previous Page" backbtn="/homeregist" activeMenu="" />
      <section className="registration-section">
        <div class="container">
          <div class="content">
            <div className="sub garis-bawah">FORM REGISTRATION</div>
            <br />
            <br />
            <h4>
              HELLO YISF 2025 PARTICIPANTS, Please consider the following
            ...
            <form name="regist-form">
              ...
              {/* DATA SEKOLAH START */}
              {/* DATA SEKOLAH START */}
              <h1 className="garis-bawah">SCHOOL DATA</h1>
              <div class="user-details">
                <div class="input-box">
              ...
              {/* DATA PEMBIMBING START */}
              <h1 className="garis-bawah">SUPERVISOR DATA</h1>
              <div className="user-details">
                <div class="input-box">
              ...
              {/* DETAIL PROJECT START */}
              <div className="">
                <h1 className="garis-bawah">DETAIL PROJECT</h1>
              </div>
              <div className="user-details">
                <div class="input-box">
              ...
              {/* GENERAL INFORMATION START */}
              <div className="">
                <h1 className="garis-bawah">GENERAL INFORMATION</h1>
              </div>
              <div className="user-details">
                <div class="input-box">
                ...
                <div class="input-box">
                  <label for="INFORMATION_RESOURCES" class="form-label">
                    YISF 2025 Competition Information Resources
                  </label>
                  <select
                    type="text"
