...
export default function InternationalOnline() {
  ...
  const handleCategoryChange = (e) => {
    ...
    switch (value) {
      case "Youth International Science Fair - Online Competition":
        setCategoryPrice("$105 USD");
        break;
      case "Youth International Science Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)":
        setCategoryPrice("$225 USD");
        break;
      case "Youth International Science Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)":
  ...
  const scriptURL =
    "https://script.google.com/macros/s/AKfycbykaF5GwAtgxoyFCJ_gsLm8mdCObWCObqCN0IoDxzBFGadTOExHzpU8jRu3hPVH9DUZ/exec";
  ...
  return (
    <>
      <PageTitle
        motherMenu="INTERNATIONAL PARTICIPANTS"
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO YISF 2026 INTERNATIONAL CITIZEN, Please consider the
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  ...
                  >
                    ...
                    <option value="Youth International Science Fair - Online Competition">
                      Online Competition
                    </option>
                    <option value="Youth International Science Fair - Online Competition + Certificate and Medal (SOUTH EAST ASIA ONLY)">
                      Online Competition + Certificate and Medal (SOUTH EAST
                      ASIA)
                    </option>
                    <option value="Youth International Science Fair - Online Competition + Certificate and Medal (Exclude SOUTH EAST ASIA)">
