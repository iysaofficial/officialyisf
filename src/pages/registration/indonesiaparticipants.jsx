...
export default function Indonesiaparticipants() {
  ...
  return (
    <>
      <PageTitle motherMenu="INDONESIA PARTICIPANTS" menuback="Previous Page" backbtn="/homeregist" activeMenu="" />
      <section className="registration-section">
        <div class="container">
          <div class="content">
            <div class="sub garis-bawah">FORMULIR PENDAFTARAN</div>
            <br />
            <br />
            <h4>
              HALLO PESERTA YISF 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    Sumber Informasi Kompetisi YISF 2025
                  </label>
                  <select
                    type="text"
