...
export default function Supported() {
    ...
    return (
        <>
            <section className="section-Organizer pt-0 position-relative pull-top">
                <div className="container">
                        <h1 className="fw-bold text-center">Organized By</h1>
            ...
            <section className="section-Supported pt-0 position-relative pull-top">
                <div className="container">
                        <h1 className="fw-bold text-center">Supported By</h1>
                    <div className="box p-3 bg-white">
                        <div className="row text-center mx-auto">
